...
import (
	"net/http"
	"time"
	main "github.com/mySuperMon_Middleware"
...
var (
	startRecordingValues = main.getStartRecordingValues()
)
...
func recordMetrics() {
	...
	go func () {
		for {
			SUM_ROWS_AFFECTED_GAUGE.Set(startRecordingValues.SumRowsAffected)
			SUM_SELECTED_RANGE_GAUGE.Set(startRecordingValues.SumSelectRange)
